...
<div class="container content">
    <h1 class="text-center py-3">How to use Jumpix?</h1>
    <p>Jumpix framework is built on the MVC concept. The entry point of the application is <code>public/index.php</code>.</p>
